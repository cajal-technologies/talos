import HexDecodeStdio.DecodeSecondPairInvalidOperational
...
theorem decodeSecondPair_invalid_low_reaches
    ...
    Reaches
      ...
      ⟨.running ⟨⟨callerParams, callerLocalValues, stack⟩,
        ...
        decodeSecondPairInvalidStore store inputPtr len chunkIndex lo
  ...
  all_goals
    ...
    simp only [lo, Mem.read8, inputPtr, secondIterator] at hloUpper hloLower hloDigit
