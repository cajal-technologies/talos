...
/-- Invalid-high-byte leg of the generated two-byte iterator. -/
theorem twp_decodePair_invalid_high
    ...
    (hhiUpper : ¬ (((4294967231 + hi.toUInt32) &&& 255) < 6))
    (hhiLower : ¬ (((4294967199 + hi.toUInt32) &&& 255) < 6))
    (hhiDigit : ¬ (((4294967248 + hi.toUInt32) &&& 255) < 10))
    ...
    (runtimeModuleOwn ⟨0⟩ «module» ∗
      ...
      pointsTo_u32 0 (errorPtr + 0) (hi.toUInt32 &&& 255) ∗
