import HexDecodeStdio.DecodeLoopPairInvalidOperational
...
theorem decodeLoopPair_invalid_low_reaches
    ...
    Reaches
      ...
      ⟨.running ⟨⟨callerParams, callerLocalValues, stack⟩,
        ...
        decodeLoopPairInvalidStore store inputPtr len chunkIndex lo
  ...
  obtain ⟨hloUpper, hloLower, hloDigit⟩ :=
    Submission.HexDecodeStdio.hexValue_none_tests lo hlo
  ...
  all_goals
    ...
    simp only [lo, Mem.read8, inputPtr, loopIterator] at hloUpper hloLower hloDigit
