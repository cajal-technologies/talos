...
@[simp] abbrev readToEndStack : UInt32 := 1048496
@[simp] abbrev readToEndVector : UInt32 := 1048500
@[simp] abbrev readToEndResult : UInt32 := 1048512
@[simp] abbrev readToEndIgnored : UInt32 := 1048527
@[simp] abbrev firstChunkFrame : UInt32 := 1048448
@[simp] abbrev firstChunkBuffer : UInt32 := 1048456
@[simp] abbrev firstChunkResult : UInt32 := 1048488
  ...
  · simp only [if_neg hempty]
    ...
    have hsuccessFacts : ∀ allocStore,
      ...
      · rw [hreservedPages]
        ...
        change 1048456 + count.toNat ≤ allocStore.wasm.mem.pages * 65536
        omega
      · rw [hreservedPages]
        have hc : count.toNat ≤ 32 := hcountNat ▸ hlen
        ...
        omega
      · rw [hreservedPages]
        change 1048520 ≤ allocStore.wasm.mem.pages * 65536
        omega
      · rw [hreservedPages]
        change 1048508 ≤ allocStore.wasm.mem.pages * 65536
        omega
      · rw [hreservedPages]
        change 1048512 ≤ allocStore.wasm.mem.pages * 65536
        omega
    ...
    exact read_chunk_after_read_reserve after outerParams outerLocalValues
      ...
      (UInt32.toInt32_not_negative_of_small _ (by omega))
