...
private theorem twp_shrU32 {hlc : HasLC} {α : Type} [WasmSmallStepGS hlc α]
...
theorem twp_load8U {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
    {params localValues values : List Value} {address offset : UInt32}
  ...
  ihave %Hfacts :
      ⌜store.wasm.mem.read8 (address + offset) = byte ∧
        (address + offset).toNat < store.wasm.mem.pages * 65536⌝ $$ [Hσ Hbyte]
  · imod stateInterp_pointsTo_facts store ns obs nt (address + offset) byte
        $$ [$Hσ $Hbyte] with %Hfacts
    ipureintro
    exact Hfacts
...
theorem twp_load8U_zero {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
...
theorem hdtwp_returnFromCallFallthrough' {hlc : HasLC} {α : Type}
  ...
  · imod stateInterp_currentInstance_agree store ns obs nt
...
theorem func18_low_body {hlc : HasLC} {α : Type} [WasmSmallStepGS hlc α]
  ...
  iapply twp_load32 saved h0 h1 h2 h3 $$ Hstate0
  iintro Hstate0
  iapply twp_localSet rfl
  iapply twp_localGet rfl
  iapply twp_const
  iapply twp_store32 saved h0 h1 h2 h3 $$ Hstate0
  iintro Hstate0
  iapply twp_block
  iapply twp_localGet rfl
  iapply twp_const
...
theorem func18_high_body {hlc : HasLC} {α : Type} [WasmSmallStepGS hlc α]
  ...
  simp only [Project.HexStdio.func18]
  iapply twp_localGet rfl
  iapply twp_load32 sentinel p0 p1 p2 p3 $$ Hcurrent0
  iintro Hcurrent0
  iapply twp_localSet rfl
  iapply twp_localGet rfl
  iapply twp_const
  iapply twp_store32 sentinel p0 p1 p2 p3 $$ Hcurrent0
  iintro Hcurrent0
  iapply twp_block
  iapply twp_localGet rfl
  iapply twp_const
  iapply twp_ne (result := 0) (by rfl)
  iapply twp_brIfZero
  iapply twp_const
  iapply twp_localSet rfl
  iapply twp_localGet rfl
  iapply twp_load32 index p4 p5 p6 p7 $$ Hindex
  iintro Hindex
  ...
  iapply twp_const
  iapply twp_add
  iapply twp_store32 index p4 p5 p6 p7 $$ Hindex
  iintro Hindex
  iapply twp_localGet rfl
  iapply twp_localGet rfl
  iapply twp_load32 1048576 p12 p13 p14 p15 $$ HtablePtr
  iintro HtablePtr
  iapply twp_localTee rfl
  iapply twp_localGet rfl
  iapply twp_load8U byte hi0 $$ Hinput0
  iintro Hinput0
  iapply twp_localTee rfl
  iapply twp_const
  iapply twp_and
  ...
  · rw [UInt32.add_comm (UInt32.ofNat (byte.toNat % 16)) 1048576]
    iexact Hlow
  iapply twp_load8U_zero (address := UInt32.ofNat (byte.toNat % 16) + 1048576)
    (hexDigit (byte.toNat % 16)) $$ HlowActual
  iintro Hlow
  ihave HcurrentAt0 : pointsTo_u32 0 (ptr + 0) (1114112 : UInt32) $$ [Hcurrent0]
  · rw [UInt32.add_zero]
    iexact Hcurrent0
  iapply twp_store32 (1114112 : UInt32) p0 p1 p2 p3 $$ HcurrentAt0
  iintro Hcurrent0
  ihave HlowCanonical :
...
theorem func18_end_body {hlc : HasLC} {α : Type} [WasmSmallStepGS hlc α]
  ...
  iapply twp_localSet rfl
  iapply twp_localGet rfl
  iapply twp_load32 finish p4 p5 p6 p7 $$ Hindex
  iintro Hindex
  iapply twp_localTee rfl
  iapply twp_localGet rfl
  iapply twp_load32 finish p8 p9 p10 p11 $$ Hend
...
theorem twp_call_func18_low {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
    (ptr saved : UInt32) (hsaved : saved ≠ sentinel)
    (hptr : ptr.toNat + 4 < UInt32.size)
  ...
  iapply Wasm.SmallStep.twp_call Project.HexStdio.«module» 21
    Project.HexStdio.func18Def (by decide) (by rfl) ⟨0⟩ $$ Hruntime
  iintro Hruntime
...
theorem twp_call_func18_high {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
...
theorem twp_call_func18_end {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
...
theorem twp_call_func18_high_at {hlc : HasLC} {α : Type}
    [WasmSmallStepGS hlc α] {s : Stuckness} {E : CoPset}
    {Φ : List Value → IProp (WasmHeapGF α)}
  ...
  subst byte
  iapply twp_call_func18_high iter (source + UInt32.ofNat i)
