...
/-- The public partial contract of `map_get`, conditional on the one open
body contract.  This theorem is not tagged `@[proves]`, because its
hypothesis is not discharged yet. -/
