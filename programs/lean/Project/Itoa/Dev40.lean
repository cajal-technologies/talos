...
private theorem func40_chunk_loop (env : HostEnv Unit) (n : UInt64) (out fp : UInt32)
    ...
    (htab : ∀ t : Nat, t < 200 →
      B (1049400 + t) = («module».initialStore (α := Unit)).mem.bytes (1049400 + t))
  ...
  · -- step
    ...
    · -- `v > 999`: peel one more chunk of four digits
      ...
      apply wp_call_of_terminates (func39_spec env _ fp 1049400 200
      ...
      have haddr1 : Frozen ((UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 10000 / 100) <<< 1 +
          1049400).toNat = 1049400 + 2 * (n.toNat / 10 ^ (4 * k) % 10000 / 100)) :=
        Frozen.mk (by
          rw [hshl_q,
      ...
      have hbyte1 : st7.mem.read8
          (UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 10000 / 100) <<< 1 + 1049400) =
      ...
      have ptab1 : ¬ (1114112 <
          (UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 10000 / 100) <<< 1 + 1049400).toNat
            + 0 + 1) := by
        have a := haddr1.out
        omega
      ...
      have hguard_tab1 : ¬ (1114112 ≤
          ((n.toNat / 10 ^ (4 * k) % 10000 / 100 % 4294967296) <<< 1 + 1049400) %
            4294967296) := by
      ...
      have haddr2 : Frozen ((((1 : UInt32) + UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 10000 / 100) <<< 1) +
          1049400).toNat = 1049400 + (2 * (n.toNat / 10 ^ (4 * k) % 10000 / 100) + 1)) :=
        Frozen.mk (by
          rw [hshl_q, hone,
              toNat_add_of_lt _ _ (by
                rw [UInt32.toNat_ofNat_of_lt' (by simp [UInt32.size]; omega)]
      ...
      have hbyte2 : st8.mem.read8
          (((1 : UInt32) + UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 10000 / 100) <<< 1) + 1049400) =
      ...
      have hguard_tab2 : ¬ (1114112 ≤
          (1 + (n.toNat / 10 ^ (4 * k) % 10000 / 100 % 4294967296) <<< 1 + 1049400) %
            4294967296) := by
        have e1 : n.toNat / 10 ^ (4 * k) % 10000 / 100 % 4294967296 =
            n.toNat / 10 ^ (4 * k) % 10000 / 100 := Nat.mod_eq_of_lt (by omega)
        rw [e1, Nat.shiftLeft_eq]
      ...
      have haddr3 : Frozen ((UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 100) <<< 1 +
          1049400).toNat = 1049400 + 2 * (n.toNat / 10 ^ (4 * k) % 100)) :=
        Frozen.mk (by
          rw [hshl_r,
              toNat_add_of_lt _ _ (by
                rw [UInt32.toNat_ofNat_of_lt' (by simp [UInt32.size]; omega)]
      ...
      have hbyte3 : st9.mem.read8
          (UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 100) <<< 1 + 1049400) =
      ...
      have hguard_tab3 : ¬ (1114112 ≤
          ((n.toNat / 10 ^ (4 * k) % 100 % 4294967296) <<< 1 + 1049400) %
            4294967296) := by
      ...
      have haddr4 : Frozen ((((1 : UInt32) +
          UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 100) <<< 1) + 1049400).toNat =
          1049400 + (2 * (n.toNat / 10 ^ (4 * k) % 100) + 1)) :=
        Frozen.mk (by
          rw [hshl_r, hone3,
              toNat_add_of_lt _ _ (by
                rw [UInt32.toNat_ofNat_of_lt' (by simp [UInt32.size]; omega)]
      ...
      have hbyte4 : st10.mem.read8
          (((1 : UInt32) + UInt32.ofNat (n.toNat / 10 ^ (4 * k) % 100) <<< 1) + 1049400) =
      ...
      have hguard_tab4 : ¬ (1114112 ≤
          (1 + (n.toNat / 10 ^ (4 * k) % 100 % 4294967296) <<< 1 + 1049400) %
            4294967296) := by
        have e1 : n.toNat / 10 ^ (4 * k) % 100 % 4294967296 =
            n.toNat / 10 ^ (4 * k) % 100 := Nat.mod_eq_of_lt (by omega)
        rw [e1, Nat.shiftLeft_eq]
