...
def func27Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32, .i32], body := func27, results := [] }
...
def func28Def : Wasm.Function :=
  { params := [.i32], locals := [.i32], body := func28, results := [.i32] }
