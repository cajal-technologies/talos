...
def func0Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i64], body := func0, results := [], typeIdx := some 3 }
...
def func1Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func1, results := [.i32], typeIdx := some 2 }
...
def func2Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func2, results := [], typeIdx := some 4 }
...
def func3Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [], body := func3, results := [.i32], typeIdx := some 5 }
...
def func4Def : Wasm.Function :=
  { params := [], locals := [], body := func4, results := [], typeIdx := some 6 }
...
def func6Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [.i32], body := func6, results := [], typeIdx := some 7 }
...
def func7Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func7, results := [], typeIdx := some 0 }
...
def func8Def : Wasm.Function :=
  { params := [.i32], locals := [.i32], body := func8, results := [], typeIdx := some 8 }
...
def func9Def : Wasm.Function :=
  { params := [.i32], locals := [.i32], body := func9, results := [], typeIdx := some 8 }
...
def func10Def : Wasm.Function :=
  { params := [.i32], locals := [], body := func10, results := [], typeIdx := some 8 }
...
def func11Def : Wasm.Function :=
  { params := [.i32], locals := [], body := func11, results := [], typeIdx := some 8 }
...
def func13Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32], body := func13, results := [], typeIdx := some 8 }
...
def func14Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32, .i64], body := func14, results := [], typeIdx := some 9 }
...
def func15Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32], body := func15, results := [], typeIdx := some 7 }
...
def func16Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func16, results := [], typeIdx := some 0 }
...
def func17Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func17, results := [], typeIdx := some 0 }
...
def func19Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32], body := func19, results := [.i32], typeIdx := some 2 }
...
def func20Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i64], body := func20, results := [.i32], typeIdx := some 10 }
...
def func21Def : Wasm.Function :=
  { params := [], locals := [], body := func21, results := [], typeIdx := some 6 }
...
def func22Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32], body := func22, results := [], typeIdx := some 4 }
...
def func23Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32, .i32], body := func23, results := [], typeIdx := some 8 }
...
def func24Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32], body := func24, results := [.i32], typeIdx := some 5 }
...
def func25Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32], body := func25, results := [], typeIdx := some 0 }
...
def func26Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32], body := func26, results := [], typeIdx := some 0 }
...
def func27Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i64], body := func27, results := [], typeIdx := some 8 }
...
def func29Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32], body := func29, results := [], typeIdx := some 0 }
...
def func30Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32], body := func30, results := [], typeIdx := some 0 }
...
def func31Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32], body := func31, results := [.i32], typeIdx := some 10 }
...
def func33Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func33, results := [], typeIdx := some 0 }
...
def func34Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func34, results := [.i32], typeIdx := some 2 }
...
def func37Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32], body := func37, results := [], typeIdx := some 0 }
...
def func39Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32], body := func39, results := [.i32], typeIdx := some 2 }
...
def func40Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32], body := func40, results := [.i32], typeIdx := some 1 }
...
def func41Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i64], body := func41, results := [], typeIdx := some 0 }
...
def func42Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i64], body := func42, results := [], typeIdx := some 0 }
...
def func44Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func44, results := [.i32], typeIdx := some 1 }
...
def func45Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32], body := func45, results := [], typeIdx := some 4 }
...
def func48Def : Wasm.Function :=
  { params := [], locals := [], body := func48, results := [], typeIdx := some 6 }
...
def func49Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func49, results := [], typeIdx := some 4 }
...
def func50Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32], body := func50, results := [], typeIdx := some 4 }
...
def func51Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func51, results := [.i32], typeIdx := some 5 }
...
def func52Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i64], body := func52, results := [], typeIdx := some 4 }
...
def func53Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i64], body := func53, results := [.i32], typeIdx := some 11 }
...
def func54Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func54, results := [.i32], typeIdx := some 2 }
...
def func55Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [], body := func55, results := [.i32], typeIdx := some 12 }
...
def func56Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func56, results := [.i32], typeIdx := some 1 }
...
def func57Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func57, results := [.i32], typeIdx := some 2 }
...
def «module» : Wasm.Module :=
{
  ...
  globals := [
    ...
    { init := .i32 (1049793 : UInt32), declaredType := some (.i32), isMut := false, sourceInit := some ([
        .const (1049793 : UInt32)
      ]), initExpr := [] },
    { init := .i32 (1049808 : UInt32), declaredType := some (.i32), isMut := false, sourceInit := some ([
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, offsetType := some (.i32), offsetExprPresent := false, elemType := some (.funcref), declarative := false, funcs := [some 16, some 8, some 40, some 39, some 44, some 38, some 37, some 35, some 36, some 9, some 34, some 42, some 41, some 43, some 33, some 32, some 57], exprs := [], offsetExpr := [] }
  ],
  importedGlobals := [],
  importedTables := [],
  importedMemories := [],
