...
def func9Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func9, results := [] }
...
def func10Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [], body := func10, results := [.i32] }
...
def func11Def : Wasm.Function :=
  { params := [], locals := [], body := func11, results := [] }
...
def func56Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func56, results := [] }
...
def «module» : Wasm.Module :=
{
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, funcs := [some 23, some 15, some 47, some 46, some 51, some 45, some 44, some 42, some 43, some 16, some 41, some 49, some 48, some 50, some 40, some 39] }
  ]
}
