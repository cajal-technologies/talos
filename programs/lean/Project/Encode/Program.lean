...
def func0 : Wasm.Program :=
  ...
  .block 0 0 [
    ...
    .block 0 0 [
      ...
      .store32 (24 : UInt32),
      .const (0 : UInt32),
      .load32 (1048576 : UInt32),
      .localSet 5,
      .const (0 : UInt32),
      .load32 (1048580 : UInt32),
      .localSet 6,
      .localGet 4,
      .localGet 5,
      .store32 (8 : UInt32),
...
def func0Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32], body := func0, results := [] }
...
def func2Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32], body := func2, results := [] }
...
def func3Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [.i32, .i64, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func3, results := [] }
...
def func5Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32], body := func5, results := [] }
...
def func6Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32], body := func6, results := [] }
...
def func7Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32], body := func7, results := [] }
...
def func8Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [], body := func8, results := [] }
...
def func13Def : Wasm.Function :=
  { params := [], locals := [], body := func13, results := [] }
...
def func22Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32], body := func22, results := [] }
...
def func23Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32, .i64], body := func23, results := [] }
    ...
    .block 0 0 [
      .block 0 0 [
        .block 0 0 [
          ...
          .const (1 : UInt32),
          .add,
          .store32 (1049028 : UInt32),
          .const (0 : UInt32),
          .load32 (1049032 : UInt32),
          .eqz,
          .br_if 1,
          .localGet 5,
          .const (8 : UInt32),
...
def func24Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32, .i32], locals := [.i32, .i32], body := func24, results := [] }

def func25 : Wasm.Program :=
  [
  .const (0 : UInt32),
  .const (1 : UInt32),
  .store8 (1049496 : UInt32)
]
...
def func28Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32], body := func28, results := [.i32] }
                ...
                .block 0 0 [
                  ...
                  .block 0 0 [
                    .block 0 0 [
                      ...
                      .const (0 : UInt32),
                      .const (1049196 : UInt32),
                      .store32 (1049208 : UInt32),
                      .const (0 : UInt32),
                      .const (1049188 : UInt32),
                      .store32 (1049196 : UInt32),
                      .const (0 : UInt32),
                      .const (1049204 : UInt32),
                      .store32 (1049216 : UInt32),
                      .const (0 : UInt32),
                      .const (1049196 : UInt32),
                      .store32 (1049204 : UInt32),
                      .const (0 : UInt32),
                      .const (1049212 : UInt32),
                      .store32 (1049224 : UInt32),
                      .const (0 : UInt32),
                      .const (1049204 : UInt32),
                      ...
                      .store32 (1049240 : UInt32),
                      .const (0 : UInt32),
                      .const (1049220 : UInt32),
                      .store32 (1049228 : UInt32),
                      .const (0 : UInt32),
                      .const (1049236 : UInt32),
                      .store32 (1049248 : UInt32),
                      .const (0 : UInt32),
                      .const (1049228 : UInt32),
                      .store32 (1049236 : UInt32),
                      .const (0 : UInt32),
                      ...
                      .const (0 : UInt32),
                      .const (1049252 : UInt32),
                      .store32 (1049264 : UInt32),
                      .const (0 : UInt32),
                      .const (1049244 : UInt32),
                  ...
                  .block 0 0 [
                    ...
                    .store32 (4 : UInt32),
                    .const (0 : UInt32),
                    .load64 (1049172 : UInt32),
                    .localSet 10,
                    .localGet 7,
                    .const (16 : UInt32),
                    .add,
                    .const (0 : UInt32),
                    .load64 (1049180 : UInt32),
                    .store64 (0 : UInt32),
                    .localGet 7,
                    .const (8 : UInt32),
                    .add,
...
def func29Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32, .i64], body := func29, results := [.i32] }
...
def func31Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32, .i32], body := func31, results := [] }
...
def func32Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i32, .i32, .i32], body := func32, results := [] }
...
def func33Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32], body := func33, results := [.i32] }
...
def func35Def : Wasm.Function :=
  { params := [.i32, .i32], locals := [.i32, .i32], body := func35, results := [] }
...
def func36Def : Wasm.Function :=
  { params := [.i32], locals := [.i32, .i64], body := func36, results := [] }
...
def func41 : Wasm.Program :=
  ...
  .const (0 : UInt32),
  .const (0 : UInt32),
  .load32 (1049040 : UInt32),
  .localSet 2,
  .localGet 2,
  .const (1 : UInt32),
  .add,
  .store32 (1049040 : UInt32),
  .block 0 0 [
    .localGet 2,
    .const (0 : UInt32),
    .ltS,
    ...
    .const (0 : UInt32),
    .const (0 : UInt32),
    .load32 (1049016 : UInt32),
    .const (1 : UInt32),
    .add,
    .store32 (1049016 : UInt32),
    .const (2 : UInt32),
    .localSet 1
  ],
  .localGet 1
...
def func42 : Wasm.Program :=
  ...
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048688 : UInt32),
  .store64 (8 : UInt32),
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048680 : UInt32),
  .store64 (0 : UInt32)
]
...
def func43 : Wasm.Program :=
  ...
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048672 : UInt32),
  .store64 (8 : UInt32),
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048664 : UInt32),
  .store64 (0 : UInt32)
]
...
def func58Def : Wasm.Function :=
  { params := [], locals := [], body := func58, results := [] }
...
def func59Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [], body := func59, results := [] }
...
def func60Def : Wasm.Function :=
  { params := [.i32, .i32, .i32], locals := [.i32], body := func60, results := [] }
...
def func61Def : Wasm.Function :=
  { params := [.i32, .i32, .i32, .i32], locals := [.i32, .i32, .i32, .i32, .i32, .i32, .i32, .i32], body := func61, results := [.i32] }
...
def «module» : Wasm.Module :=
{
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, funcs := [some 25, some 17, some 50, some 49, some 54, some 48, some 47, some 45, some 46, some 18, some 44, some 52, some 51, some 53, some 43, some 42] }
  ]
}
