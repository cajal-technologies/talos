    ...
    .block 0 0 [
      .block 0 0 [
        .block 0 0 [
          ...
          .const (1 : UInt32),
          .add,
          .store32 (1049132 : UInt32),
          .const (0 : UInt32),
          .load32 (1049136 : UInt32),
          .eqz,
          .br_if 1,
          .localGet 5,
          .const (8 : UInt32),
...
def func35 : Wasm.Program :=
  ...
  .const (0 : UInt32),
  .const (0 : UInt32),
  .load32 (1049144 : UInt32),
  .localSet 2,
  .localGet 2,
  .const (1 : UInt32),
  .add,
  .store32 (1049144 : UInt32),
  .block 0 0 [
    .localGet 2,
    .const (0 : UInt32),
    .ltS,
...
def func36 : Wasm.Program :=
  ...
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048732 : UInt32),
  .store64 (8 : UInt32),
  .localGet 0,
  .const (0 : UInt32),
  .load64 (1048724 : UInt32),
  .store64 (0 : UInt32)
]
...
def «module» : Wasm.Module :=
{
  ...
  funcs := [
    ...
    { params := [.i32], locals := [.i32, .i32, .i32], body := func2, results := [.i32] },
    { params := [.i32], locals := [.i32, .i32, .i32], body := func3, results := [] },
    { params := [.i32], locals := [.i32], body := func4, results := [] },
  ...
  elements := [
    { tableIdx := some 0, offset := some 1, funcs := [some 20, some 12, some 44, some 43, some 48, some 42, some 41, some 39, some 40, some 13, some 38, some 46, some 45, some 47, some 37, some 36] }
  ]
}
