...
private theorem reassembleUInt64Bytes (n : Nat) (h : n < 2 ^ 64) :
  ...
  by_cases hi8 : i < 8
  · simp [hi8, show i < 64 by omega, show ¬i ≥ 8 by omega,
      show ¬i ≥ 16 by omega, show ¬i ≥ 24 by omega,
      show ¬i ≥ 32 by omega, show ¬i ≥ 40 by omega,
      show ¬i ≥ 48 by omega, show ¬i ≥ 56 by omega]
  by_cases hi16 : i < 16
  · have h8le : i ≥ 8 := by omega
    have heq : 8 + (i - 8) = i := by omega
    simp [hi8, h8le, heq, show i < 64 by omega,
      show i - 8 < 8 by omega, show ¬i ≥ 16 by omega,
      show ¬i ≥ 24 by omega, show ¬i ≥ 32 by omega,
      show ¬i ≥ 40 by omega, show ¬i ≥ 48 by omega,
      show ¬i ≥ 56 by omega]
  by_cases hi24 : i < 24
  · have h16le : i ≥ 16 := by omega
    have heq : 16 + (i - 16) = i := by omega
    simp [hi8, h16le, heq, show i < 64 by omega,
  ...
  · have h24le : i ≥ 24 := by omega
    ...
    simp [hi8, h24le, heq, show i < 64 by omega,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show i - 24 < 8 by omega, show ¬i ≥ 32 by omega,
      show ¬i ≥ 40 by omega, show ¬i ≥ 48 by omega,
      show ¬i ≥ 56 by omega]
  by_cases hi40 : i < 40
  · have h32le : i ≥ 32 := by omega
    have heq : 32 + (i - 32) = i := by omega
    simp [hi8, h32le, heq, show i < 64 by omega,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show ¬i - 24 < 8 by omega, show i - 32 < 8 by omega,
      show ¬i ≥ 40 by omega, show ¬i ≥ 48 by omega,
      show ¬i ≥ 56 by omega]
  by_cases hi48 : i < 48
  · have h40le : i ≥ 40 := by omega
    have heq : 40 + (i - 40) = i := by omega
    simp [hi8, h40le, heq, show i < 64 by omega,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show ¬i - 24 < 8 by omega, show ¬i - 32 < 8 by omega,
      show i - 40 < 8 by omega, show ¬i ≥ 48 by omega,
      show ¬i ≥ 56 by omega]
  by_cases hi56 : i < 56
  · have h48le : i ≥ 48 := by omega
    have heq : 48 + (i - 48) = i := by omega
    simp [hi8, h48le, heq, show i < 64 by omega,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show ¬i - 24 < 8 by omega, show ¬i - 32 < 8 by omega,
      show ¬i - 40 < 8 by omega, show i - 48 < 8 by omega,
      show ¬i ≥ 56 by omega]
  by_cases hi64 : i < 64
  · have h56le : i ≥ 56 := by omega
    have heq : 56 + (i - 56) = i := by omega
    simp [hi8, hi64, h56le, heq,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show ¬i - 24 < 8 by omega, show ¬i - 32 < 8 by omega,
      show ¬i - 40 < 8 by omega, show ¬i - 48 < 8 by omega,
      show i - 56 < 8 by omega]
  · have hibound : n.testBit i = false := by
      apply Nat.testBit_eq_false_of_lt
      exact _root_.lt_of_lt_of_le h
        (Nat.pow_le_pow_right (by decide) (by omega))
    simp [hi8, hibound, show ¬i < 64 by omega,
      show ¬i - 8 < 8 by omega, show ¬i - 16 < 8 by omega,
      show ¬i - 24 < 8 by omega, show ¬i - 32 < 8 by omega,
      show ¬i - 40 < 8 by omega, show ¬i - 48 < 8 by omega,
      show ¬i - 56 < 8 by omega]
...
theorem u64Byte_reassemble (v : UInt64) :
  ...
  simp only [u64Byte, UInt64.toNat_or, UInt64.toNat_shiftLeft,
    UInt8.toNat_toUInt64, UInt64.toNat_toUInt8,
    UInt64.toNat_shiftRight]
  exact reassembleUInt64Bytes v.toNat (UInt64.toNat_lt v)
...
private theorem reassembleUInt32Bytes (n : Nat) (h : n < 2 ^ 32) :
...
theorem u32Byte_reassemble (v : UInt32) :
  ...
  simp only [u32Byte, UInt32.toNat_or, UInt32.toNat_shiftLeft,
    UInt8.toNat_toUInt32, UInt32.toNat_toUInt8,
    UInt32.toNat_shiftRight]
  exact reassembleUInt32Bytes v.toNat (UInt32.toNat_lt v)
